...
<head>
  ...
  <link rel="stylesheet" href="../css/desinscrever.css">
...
<body>
    ...
    <section>
        <div id="mensagem" class="mensagem-enviada">
            ...
            <svg 
                ...
                <h1>Você foi desinscrito das lições personalizadas da etec jrm</h1>   
            </div>
        </div> 
    </section>
  </main>
  ...
  <?php 
        ...
        $nome = $_POST['nome'];
        $email = $_POST['email'];
        $sql = "DELETE * FROM aluno WHERE nome = '$nome' and email = '$email';";
        ...
        if ($query->num_rows > 0) {
            ...
            $txt = "Você se desinscreveu das lições personalizadas da etec jrm!";
