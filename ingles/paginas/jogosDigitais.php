  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>HIGH SCHOOL WITH DIGITAL GAME PROGRAMMING</h1>
        <p>In this teaching modality, based on Law No. 13,415 / 17, the student will attend high school structured in conjunction with the formation of Technician in Programming of Digital Games
, in a journey up to 30 weekly classes (up to 6 daily classes), in each of the 3 series. At the end of the course, the student will have completed High School and will also obtain the diploma of
Technician in Programming of Digital Games, with national validity, according to the following professional profile: It is the professional who composes multidisciplinary teams in the construction of digital games. Designs, develops and implements digital games.
Codifies programs, develops and publishes sound and graphic elements in two and three dimensions; manages and supports digital games. Plans and develops marketing and dissemination actions. Selects work resources, programming languages,
tools and methodologies for the development of digital games in various media, such as: consoles, microcomputers, mobile devices and the Internet.
        </p>
...
<br> Course coordinator: Prof. Me. Robson Vanderlei Alves de Andrade <br>
		<br> <br><a href="http://etecjrm.com.br/wp-content/uploads/2019/02/Programação-de-Jogos-Digitais-MTec-339_1ª-Série_2018.pdf">Course Matrix</a></p>
        </p>
    </section>
  </main>
