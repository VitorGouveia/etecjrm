        ...
        <div class="row">
          <div onclick="audioVideo()" class="audio-video">
            <div class="top">
              ...
              <h1><a href="audioVideo.php">Audio and Video</a></h1>        
            </div>
          </div>
        ...
        <div class="row">
          <div onclick="comunicacaoVisual()" class="comunicacao-visual">
            <div class="top">
              ...
              <h1><a href="comunicacaoVisual.php">Visual Communication</a></h1>        
            </div>
          </div>
          ...
          <div onclick="tecnicoWeb()" class="tecnico-web">
            <div class="top">
              ...
              <h1><a href="tecnicoWeb.php">Web Computing</a></h1>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div onclick="jogosDigitais()" class="jogos-digitais">
            <div class="top">
              ...
              <h1><a href="jogosDigitais.php">Digital Games</a></h1>        
            </div>
          </div>
