  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>HIGH SCHOOL WITH TECHNIC IN WEB COMPUTING</h1>
        <p>In this teaching modality, based on Law No. 13,415 / 17, the student will attend high school structured in conjunction with the formation of Computer Technician for Internet,
in a journey up to 30 weekly classes (up to 6 daily classes), in each of the 3 series. At the end of the course, the student will have completed high school and will also obtain the diploma of Computer Technician for Internet,
with national validity, according to the following professional profile: The Computer Technician for Internet is the professional who develops and performs maintenance on websites and portals on the Internet and Intranet.
Uses project development tools to build solutions that assist the process of creating interfaces and applications used in electronic commerce and marketing.
        </p>

        <h1>JOB MARKET</h1>
        <p>Public, private and third sector institutions that require computer programming for the Internet. <br>
<br> Course coordinator: Professor Danillo Santos <br>
		<br> <a href="https://docs.google.com/presentation/d/1UVf_m9dTF4dyedDJBHPGRbdGIfyIP_r1IIb289rJBh4/edit#slide=id.p">Course Presentation</a><br>
		<br><a href="https://drive.google.com/file/d/101aSW2eIknmeg4iyfXE8_D1jQAl4gJ97/view">Course Matrix</a></p>
        </p>
