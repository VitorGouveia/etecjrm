...
<body>
  ...
  <nav>
      ...
      <div class="menu">
        ...
        <a href="./espacoAluno.php" rel="noopener" class="active">STUDENT SPACE</a>
    ...
    <section>
      ...
      <div class="teams-widget">
        <div class="top">
          ...
          <h1>Enter ETEC's <a href="https://www.microsoft.com/pt-br/microsoft-365/microsoft-teams/download-app" target="_blank" rel="noopener" class="yellow">Teams</a> channel</h1>        
        </div>
      </div>

      <div class="email-institucional">
        <form action="emailInstitucional.php" method="post">
          <h2>If you don't have your institutional email yet, get yours now</h2>
          ...
          <button type="submit">Get your institutional email</button>
        </form>
      </div>
    </section>
  </main>
