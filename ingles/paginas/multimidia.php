  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>MULTIMEDIA TECHNICIAN</h1>
        <p>The Multimedia Technician is the professional who develops visual communication in electronic media, organizes and prepares digital files that can compose screens
for communication systems for different purposes. Applies static and moving image treatment techniques that complement navigation structures in digital media.
Performs updating of websites, portals and web pages. Prepares technical texts according to the fundamentals and terminology of the professional area.
        </p>

        <h1>JOB MARKET</h1>
        <p>The Multimedia Technician job market is wide, covering several areas of audiovisual communication, such as digital cinema, interactive TV, video and animation. Operates in the design of routes,
production designs, editing and special effects in communication companies - radio and television - new media and alternative spaces for social interaction, leisure and culture.
You will be able to develop works on Internet portals, multimedia producers, advertising and communication creation offices, online newspaper and magazine publishers.
        </p>

        <h1>PROFESSIONAL REGISTER</h1>
        <p>The student trained in the Multimedia Technician course receives a Professional Registration that enables him to work in several areas. <br>
<br> Course coordinator: Professor Juliana Lamas<br>
		<br> <a href="http://etecjrm.com.br/wp-content/uploads/2020/08/Plano-de-Curso-Multimídia-NOVO.pdf">Course Matrix</a></p>
        </p>
    </section>
  </main>
