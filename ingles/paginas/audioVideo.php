  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>AUDIO AND VIDEO</h1>
        <p>The technician in audio and video production is the professional who collaborates in capturing image and sound, in the setting, operation of equipment, through resources,
language and technology within the technical standards of the different media. Collaborates in the research and
the use of new technologies related to language, acoustic and image treatment, luminosity, animation.
Prepares audiovisual material. Prepares technical files, programming maps, distribution, placement of communication products and services
        </p>

        <h1>JOB MARKET</h1>
        <p>The job market for the AUDIO AND VIDEO PRODUCTION TECHNICIAN is wide, covering several areas of audiovisual communication, such as digital cinema, interactive TV, video and animation.
Works in the design of scripts, production drawings, editing and special effects in communication companies - radio and television - new media and alternative spaces for social interaction, leisure and culture. You can develop work on Internet providers,
independent production companies, recording studios, advertising and communication creation offices
, broadcasting and telecommunications companies, as well as development and research laboratories in audiovisual communication.
        </p>

        <h1>PROFESSIONAL REGISTER</h1>
        <p>The student graduated in the Technical Course in Audio and Video Production receives a PROFESSIONAL REGISTRATION that enables him to work in several areas. Find out here what they are. <br>
<br> Course coordinator: Professor Nelson Caramico.<br>
		<br> <a href="https://drive.google.com/file/d/0B46LlaTiiDyYc3plbzBnbl9aS2s/view?pref=2&pli=1">Course Matrix</a></p>
        </p>
    </section>
  </main>
