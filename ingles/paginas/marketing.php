  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>HIGH SCHOOL WITH TECHNICAL MARKETING</h1>
        <p>In this teaching modality, based on Law No. 13,415 / 17, the student will attend high school structured in conjunction with the training of Marketing Technician
, in a journey up to 30 weekly classes (up to 6 daily classes), in each of the 3 series. At the end of the course, the student will have completed high school and
also, the diploma of Marketing Technician, with national validity, according to the following professional profile: The Marketing Technician is the professional who
collaborates in the elaboration of the company's marketing plan, according to its branch or size, having the competence allied to the technical domain and in the planning and implementation of sales actions
and market shares. Performs task of analysis of sales, prices and products. Operationalizes the company's communication policies: customer loyalty, relationship with suppliers or other entities.
Operationalizes product presentation policies at the point of sale. Performs control, statistics and telemarketing operations. Participates in the preparation and conduct of market studies, interprets and applies the legislation of the area.

        </p>

        <h1>JOB MARKET</h1>
        <p> Public institutions; private and third sector; trade; consulting companies and autonomously.<br>
		<br> <a href="https://drive.google.com/file/d/1-ze2R-1epBtHxFNBbqPBekIu81QwbRHS/view">Course Matrix</a></p>
        </p>
