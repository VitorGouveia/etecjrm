  ...
  <header>
    <nav>
      ...
      <div class="menu">
        ...
        <a href="./proposito.php" rel="noopener"  class="active">PURPOSE</a>
  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>HISTORY</h1>
        <p> Since August 1, 2011, the city of São Paulo and its metropolitan region has gain the State Technical School
            Jornalista Roberto Marinho (Etec JRM), the result of an agreement between the Government of the State of São Paulo,
            Roberto Marinho Foundation and Globo TV. Etec JRM joins the Paula Souza State Center for Technological Education
             - the largest professional education institution in the country. The courses - Multimedia (duration of three semesters) and
             Audio and Video Production (duration of four semesters) - were prepared by specialists from Paula
             Souza Center in partnership with Globo professionals. Paula Souza will be responsible for monitoring the selection process,
             hiring of teachers, the purchase of furniture and equipment, and the infrastructure for the functioning of the
             courses. The new Etec building was built by Globo, on land provided by the state government. It also fit 
             the company to implement the landscaping project in the school area. The Paula Souza Center was responsible for
             monitoring the students' selection process, hiring teachers, buying furniture
             and equipment, and the infrastructure for the operation of the courses and their maintenance. In addition to the theoretical classes
             held in one of the 06 classrooms, the practical activities of the four courses take place in one of the 05 laboratories
             of Informatics, where two of them are composed by 25 latest generation's Macintoshs, and also in the audio and
             video studio that is being assembled at Etec's premises.
        </p>

        <h1>MISSION</h1>
        <p>Promote public professional education of excellence, in the areas of cultural production and design, aiming to meet social demands and the world of work in this especific area.</p>

        <h1>VISION</h1>
        <p>Consolidate itself as a Teaching Unit of excellence and stimulating human and technological development, based on the principle
           of the use of the media in its highest performance and efficiency.
        </p>
    </section>
  </main>
