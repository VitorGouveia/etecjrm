  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>ESCUELA SECUNDARIA CON COMUNICACIÓN VISUAL</h1>
        <p>En esta modalidad docente, con base en la Ley nº 13.415 / 17, el alumno asistirá al Bachillerato estructurado en conjunto con la formación de Técnico en Comunicación Visual, en una jornada de hasta 30 clases semanales (hasta 6 clases diarias), en cada una de las 3 serie.
Al finalizar el curso, el alumno habrá culminado el bachillerato y además obtendrá el diploma de Técnico en Comunicación Visual, con validez nacional, según el siguiente perfil profesional: EL TÉCNICO EN COMUNICACIÓN VISUAL es el profesional que diseña y
ejecuta proyectos de comunicación visual de diferentes géneros y formatos gráficos para piezas publicitarias, tales como libros, portales, paneles, folletos, periódicos. Desarrolla y emplea elementos creativos y estéticos de la comunicación visual gráfica.
Crea ilustraciones, aplica tipografía, desarrolla elementos de identidad visual de piezas. Controla, organiza y almacena materiales físicos y digitales para la producción gráfica.
        </p>
		...
		<br>Coordinador del curso: Docente Juliana Lamas<br>
		<br><a href="http://etecjrm.com.br/wp-content/uploads/2019/02/Comunicação-Visual_MTec_1ª-Série.pdf">Matriz de Cursos</a></p>
        </p>
    </section>
  </main>
