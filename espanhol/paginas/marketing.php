  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>ESCUELA SECUNDARIA CON TÉCNICO DE MARKETING</h1>
        <p>En esta modalidad docente, con base en la Ley N ° 13.415 / 17, el alumno asistirá al bachillerato estructurado en conjunto con la formación de Técnico de Marketing
		, en una jornada de hasta 30 clases semanales (hasta 6 clases diarias), en cada una de las 3 series. Al final del curso, el estudiante habrá completado la escuela secundaria y
		Asimismo, el diploma de Técnico en Marketing, con validez nacional, según el siguiente perfil profesional: El Técnico en Marketing es el profesional que
		colabora en la elaboración del plan de marketing de la empresa, según su rama o tamaño, teniendo la competencia aliada al dominio técnico y en la planificación e implementación de las acciones comerciales
		y cuotas de mercado. Realiza tarea de análisis de ventas, precios y productos. Operacionaliza las políticas de comunicación de la empresa: fidelización de clientes, relación con proveedores u otras entidades.
		Operacionaliza las políticas de presentación de productos en el punto de venta. Realiza operaciones de control, estadísticas y telemarketing. Participa en la elaboración y realización de estudios de mercado, interpreta y aplica la legislación del área.</p>

        <h1>MERCADO DE TRABALHO</h1>
        <p>Instituciones públicas; sector privado y tercer; comercio; empresas consultoras y de forma autónoma. <br><br> <a href="https://drive.google.com/file/d/1-ze2R-1epBtHxFNBbqPBekIu81QwbRHS/view">Matriz de Cursos</a></p>
        </p>
