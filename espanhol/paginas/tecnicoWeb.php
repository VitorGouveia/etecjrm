...
<body>
  ...
  <main id="section">
    <div class="nomeSection">
      <h1>COMPUTACION POR INTERNET</h1>
    </div>
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>ESCUELA SECUNDARIA CON TÉCNICO DE COMPUTADORAS DE INTERNET</h1>
        <p>En esta modalidad docente, con base en la Ley N ° 13.415 / 17, el alumno asistirá al bachillerato estructurado en conjunto con la formación de Técnico en Computación para Internet,
		en una jornada de hasta 30 clases semanales (hasta 6 clases diarias), en cada una de las 3 series. Al finalizar el curso, el alumno habrá finalizado el bachillerato y también obtendrá el diploma de Técnico en Informática para Internet,
		con vigencia nacional, según el siguiente perfil profesional: El Técnico en Computación para Internet es el profesional que desarrolla y realiza el mantenimiento de sitios web y portales en Internet e Intranet.
		Utiliza herramientas de desarrollo de proyectos para crear soluciones que ayuden al proceso de creación de interfaces y aplicaciones utilizadas en el comercio electrónico y el marketing. </p>

        <h1>MERCADO DE TRABAJO</h1>
        <p>Instituciones públicas, privadas y del tercer sector que requieran programación informática para Internet.<br>
		<br>Coordinador del curso: Profesor Danillo Santos <br>
		<br> <a href="https://docs.google.com/presentation/d/1UVf_m9dTF4dyedDJBHPGRbdGIfyIP_r1IIb289rJBh4/edit#slide=id.p">Presentación del curso</a><br>
		<br><a href="https://drive.google.com/file/d/101aSW2eIknmeg4iyfXE8_D1jQAl4gJ97/view">Matriz de Cursos</a></p>
        </p>
