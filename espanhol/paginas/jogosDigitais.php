  ...
  <header>
    <nav>
      ...
      <div class="menu">
        ...
        <a href="./faleConosco.php" rel="noopener">CONTACTO CON NOSOTROS</a>
      </div>
    ...
    <section>
      <div class="previnir-widget">
        <div class="top">
          ...
          <h1>Provéase<br>Quédate en casa.<br>Usa máscara.</h1>   
        </div>
      </div>

      <hr id="separador">

        <h1>ESCUELA SECUNDARIA CON PROGRAMACIÓN DE JUEGOS DIGITALES</h1>
        <p>En esta modalidad docente, con base en la Ley N ° 13.415 / 17, el alumno asistirá al bachillerato estructurado en conjunto con la formación de Técnico en Programación de Juegos Digitales
		, en una jornada de hasta 30 clases semanales (hasta 6 clases diarias), en cada una de las 3 series. Al finalizar el curso, el alumno habrá finalizado el Bachillerato y también obtendrá el diploma de
		Técnico en Programación de Juegos Digitales, con vigencia nacional, según el siguiente perfil profesional: Es el profesional que compone equipos multidisciplinares en la construcción de juegos digitales. Diseña, desarrolla e implementa juegos digitales.
		Codifica programas, desarrolla y publica elementos sonoros y gráficos en dos y tres dimensiones; gestiona y apoya juegos digitales. Planifica y desarrolla acciones de marketing y difusión. Selecciona recursos de trabajo, lenguajes de programación,
		herramientas y metodologías para el desarrollo de juegos digitales en diversos medios, tales como: consolas, microcomputadoras, dispositivos móviles e Internet.ferramentas e metodologias para o desenvolvimento de jogos digitais em diversas mídias, tais como: consoles, microcomputadores, dispositivos móveis e Internet..
        </p>

        <h1>REQUISITOS PREVIOS</h1>
        <p>Poseer el certificado de finalización de Educación Primaria en las siguientes modalidades: Educación regular o de Jóvenes y Adultos - EJA o Examen Nacional de Certificación de Habilidades de Jóvenes y Adultos - ENCCEJA.<br>
		<br>Coordinador del curso: Profesor.Me. Robson Vanderlei Alves de Andrade<br>
		<br> <br><a href="http://etecjrm.com.br/wp-content/uploads/2019/02/Programação-de-Jogos-Digitais-MTec-339_1ª-Série_2018.pdf">Matriz do Curso</a></p>
        </p>
    </section>
  </main>
  ...
  <footer>
    <section>
      <div class="contato">
        ...
        <p><strong>Correo Electrónico:</strong> <a href="mailto:e253dir@cps.sp.gov.br" rel="noopener">mandar email</a></p>
    ...
    <div class="direitosAutorais">
      ...
      <h1>&copy;2020 ETEC JORNALISTA ROBERTO MARINHO. TODOS LOS DERECHOS RESERVADOS
	</div>
  </footer>
</body>
