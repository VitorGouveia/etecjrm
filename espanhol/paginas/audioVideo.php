  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>AUDIO Y VIDEO</h1>
        <p>El técnico en producción de audio y video es el profesional que colabora en la captura de imagen y sonido, en la ambientación, operación de equipos, a través de recursos,
		lenguaje y tecnología dentro de los estándares técnicos de los diferentes medios. Colabora en investigación y
		uso de nuevas tecnologías relacionadas con el lenguaje, tratamiento acústico y de imagen, luminosidad, animación.
		Elabora material audiovisual. Prepara archivos técnicos, mapas de programación, distribución, colocación de productos y servicios de comunicación.</p>

        <h1>MERCADO DE TRABAJO</h1>
        <p>El mercado laboral del TÉCNICO EN PRODUCCIÓN DE AUDIO Y VIDEO es amplio, abarcando varias áreas de la comunicación audiovisual, como el cine digital, la televisión interactiva, el video y la animación.
		Trabaja en el diseño de guiones, dibujos de producción, edición y efectos especiales en empresas de comunicación - radio y televisión - nuevos medios y espacios alternativos de interacción social, ocio y cultura. Puede desarrollar trabajos en proveedores de Internet,
		productoras independientes, estudios de grabación, oficinas de creación de publicidad y comunicación
		, empresas de radiodifusión y telecomunicaciones., así como laboratorios de desarrollo e investigación en comunicación audiovisual</p>

        <h1>RÉCORD PROFESIONALL</h1>
        <p>El alumno egresado del Curso Técnico en Producción de Audio y Video recibe una MATRÍCULA PROFESIONAL que le habilita para desempeñarse en diversas áreas. Conoce aquí cuáles son.
		<br>Coordenador do curso: Professor Nelson Caramico.<br>
		<br> <a href="https://drive.google.com/file/d/0B46LlaTiiDyYc3plbzBnbl9aS2s/view?pref=2&pli=1">Matriz de Cursos</a></p>
        </p>
    </section>
  </main>
