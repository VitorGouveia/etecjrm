        ...
        <div class="row">
          <div onclick="audioVideo()" class="audio-video">
            <div class="top">
              ...
              <h1><a href="audioVideo.php">Audio y video</a></h1>        
            </div>
          </div>
          ...
          <div onclick="multimidia()" class="multimedia">
            <div class="top">
              ...
              <h1><a href="multimidia.php">Multimedia</a></h1>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div onclick="comunicacaoVisual()" class="comunicacao-visual">
            <div class="top">
              ...
              <h1><a href="comunicacaoVisual.php">La comunicación visual</a></h1>        
            </div>
          </div>
          ...
          <div onclick="tecnicoWeb()" class="tecnico-web">
            <div class="top">
              ...
              <h1><a href="tecnicoWeb.php">Computación web</a></h1>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div onclick="jogosDigitais()" class="jogos-digitais">
            <div class="top">
              ...
              <h1><a href="jogosDigitais.php">Juegos digitales</a></h1>        
            </div>
          </div>
          ...
          <div onclick="marketing()" class="marketing">
            <div class="top">
              ...
              <h1><a href="marketing.php">Márketing</a></h1>
            </div>
          </div>
        </div>
      </div>
