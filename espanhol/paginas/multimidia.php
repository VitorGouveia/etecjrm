  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>TÉCNICO MULTIMEDIA</h1>
        <p>El Técnico Multimedia es el profesional que desarrolla la comunicación visual en medios electrónicos, organiza y prepara archivos digitales que pueden componer pantallas.
		para sistemas de comunicación para diferentes propósitos. Aplica técnicas de tratamiento de imágenes estáticas y en movimiento que complementan las estructuras de navegación en medios digitales.
		Realiza actualización de sitios web, portales y páginas web. Elabora textos técnicos de acuerdo con los fundamentos y terminología del área profesional </p>

        <h1>MERCADO DE TRABAJO</h1>
        <p>El mercado laboral de Técnico Multimedia es amplio, abarcando varias áreas de la comunicación audiovisual, como el cine digital, la televisión interactiva, el vídeo y la animación. Opera en el diseño de rutas,
		diseños de producción, edición y efectos especiales en empresas de comunicación - radio y televisión - nuevos medios y espacios alternativos de interacción social, ocio y cultura.
