...
<body>
  ...
  <header>
    <nav>
      ...
      <div class="menu">
        <a href="./" rel="noopener" class="active">COMIENZO</a>
        <a href="./paginas/proposito.php" rel="noopener">PROPÓSITO</a>
        <a href="./paginas/espacoAluno.php" rel="noopener">ESPACIO ESTUDIANTIL</a>
        <a href="./paginas/cursosTecnicos.php" rel="noopener">CURSOS TÉCNICOS</a>
        <a href="#" rel="noopener">CALENDARIO</a>
        <a href="./paginas/faleConosco.php" rel="noopener">HABLE CON NOSOTROS</a>
      </div>
  ...
  <main id="section">
    ...
    <section>
          ...
          <div class="esquerda">
              ...
              <div class="newsletter">
                <form action="../includes/licao.php" method="POST">
                  <h2>Ingrese sus datos a continuación para recibir nuestras lecciones personalizadas en su correo electrónico</h2>
                  ...
                  <button type="submit">Quiero recibir notificaciones personalizadas</button>
                </form>
              </div>
          </div>
      </div> 
      ...
      <div class="cps">
        <h1>Patrocinadores de ETEC JRM</h1>
        <div class="icones">
