  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>ENSINO MÉDIO COM TÉCNICO EM INFORMÁTICA PARA INTERNET</h1>
        <p>Nesta modalidade de ensino, baseada na Lei nº 13.415/17, o aluno cursará o Ensino Médio estruturado em conjunto com a formação de Técnico em Informática Para Internet,
		numa jornada de até 30 aulas semanais (até 6 aulas diárias), em cada uma das 3 séries. Ao final do curso, o aluno terá concluído o Ensino Médio e obterá, também, o diploma de Técnico em Informática Para Internet,
		com validade nacional, de acordo com o perfil profissional a seguir: O Técnico em Informática para Internet é o profissional que desenvolve e realiza manutenção em websites e portais na Internet e Intranet. 
		Utiliza ferramentas de desenvolvimento de projetos para construir soluções que auxiliam o processo de criação de interfaces e aplicativos empregados no comércio e marketing eletrônicos..
        </p>

        <h1>MERCADO DE TRABALHO</h1>
        <p>Instituições públicas, privadas e do terceiro setor que demandem programação de computadores para Internet.<br>
		<br>Coordenador do curso: Professor Danillo Santos <br>
		<br> <a href="https://docs.google.com/presentation/d/1UVf_m9dTF4dyedDJBHPGRbdGIfyIP_r1IIb289rJBh4/edit#slide=id.p">Apresentação do Curso</a><br>
		<br><a href="https://drive.google.com/file/d/101aSW2eIknmeg4iyfXE8_D1jQAl4gJ97/view">Matriz do Curso</a></p>
        </p>
