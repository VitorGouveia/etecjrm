  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>ENSINO MÉDIO COM COMUNICAÇÃO VISUAL</h1>
        <p>Nesta modalidade de ensino, baseada na Lei nº 13.415/17, o aluno cursará o Ensino Médio estruturado em conjunto com a formação de Técnico em Comunicação Visual, numa jornada de até 30 aulas semanais (até 6 aulas diárias), em cada uma das 3 séries.
		Ao final do curso, o aluno terá concluído o Ensino Médio e obterá, também, o diploma de Técnico em Comunicação Visual, com validade nacional, de acordo com o perfil profissional a seguir: O TÉCNICO EM COMUNICAÇÃO VISUAL é o profissional que projeta e 
		executa projetos de comunicação visual de diferentes gêneros e formatos gráficos para peças publicitárias, como livros, portais, painéis, fôlderes, jornais. Desenvolve e emprega elementos criativos e estéticos de comunicação visual gráfica.
		Cria ilustrações, aplica tipografias, desenvolve elementos de identidade visual de peças. Controla, organiza e armazena materiais físicos e digitais da produção gráfica.
        </p>
		...
		<br><a href="http://etecjrm.com.br/wp-content/uploads/2019/02/Comunicação-Visual_MTec_1ª-Série.pdf">Matriz do Curso</a></p>
        </p>
    </section>
  </main>
