  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>ÁUDIO E VÍDEO</h1>
        <p>O técnico em produção de áudio e vídeo é o profissional que colabora na captação de imagem e som, na ambientação, operação de equipamentos, por intermédio de recursos,
		linguagem e tecnologia dentro dos padrões técnicos dos diferentes meios de comunicação. Colabora na investigação e
		utilização de novas tecnologias relacionadas com linguagem, tratamento acústico e de imagem, luminosidade, animação. 
		Prepara material audiovisual. Elabora fichas técnicas, mapas de programação, distribuição, veiculação dos produtos e serviços de comunicação
        </p>

        <h1>MERCADO DE TRABALHO</h1>
        <p>O mercado de trabalho do TÉCNICO EM PRODUÇÃO DE ÁUDIO E VÍDEO é amplo, abrange diversas áreas da comunicação audiovisual, como cinema digital, TV interativa, vídeo e animação.
		Atua na concepção de roteiros, desenhos de produção, edição e efeitos especiais em empresas de comunicação – rádio e televisão – novas mídias e espaços alternativos de interação social, lazer e cultura. Poderá desenvolver trabalhos em provedores de Internet,
		produtoras independentes, estúdios de gravação, escritórios de criação publicitária e de comunicação
		, empresas de radiodifusão e telecomunicações., além de laboratórios de desenvolvimento e pesquisa em comunicação audiovisual
        </p>

        <h1>REGISTRO PROFISSIONAL</h1>
        <p>O aluno formado no curso Técnico em Produção de Áudio e Vídeo recebe um REGISTRO PROFISSIONAL que o habilita a trabalhar em diversas áreas. Conheça aqui quais são elas.<br>
		<br>Coordenador do curso: Professor Nelson Caramico.<br>
		<br> <a href="https://drive.google.com/file/d/0B46LlaTiiDyYc3plbzBnbl9aS2s/view?pref=2&pli=1">Matriz do Curso</a></p>
        </p>
    </section>
  </main>
