  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>TÉCNICO EM MULTIMÍDIA</h1>
        <p>O Técnico em Multimídia é o profissional que desenvolve comunicação visual em meios eletrônicos, organiza e prepara arquivos digitais que podem compor telas
		para sistemas de comunicação para diferentes finalidades. Aplica técnicas de tratamento de imagens estáticas e em movimento que complementam estruturas de navegação em mídias digitais.
		Executa atualização de sites, portais e páginas da web. Elabora textos técnicos de acordo com os fundamentos e com a terminologia da área profissional
        </p>

        <h1>MERCADO DE TRABALHO</h1>
        <p>O mercado de trabalho do Técnico em Multimídia é amplo, abrange diversas áreas da comunicação audiovisual, como cinema digital, TV interativa, vídeo e animação. Atua na concepção de roteiros, 
		desenhos de produção, edição e efeitos especiais em empresas de comunicação – rádio e televisão – novas mídias e espaços alternativos de interação social, lazer e cultura.
		Poderá desenvolver trabalhos em portais de Internet, produtoras de multimídia, escritórios de criação publicitária e de comunicação, editoras de jornais e revistas on-line.
        </p>

        <h1>REGISTRO PROFISSIONAL</h1>
        <p>O aluno formado no curso Técnico em Multimídia recebe um Registro Profissional que o habilita a trabalhar em diversas áreas.<br>
		<br>Coordenador do curso: Professora Juliana Lamas<br>
		<br> <a href="http://etecjrm.com.br/wp-content/uploads/2020/08/Plano-de-Curso-Multimídia-NOVO.pdf">Matriz do Curso</a></p>
        </p>
    </section>
  </main>
