...
<body>
      ...
      <div class="acessibilidade">
        ...
        <div class="idioma">
          ...
          <div class="dropdown">
            ...
            <div onclick="location.href = './ingles/paginas/espacoAluno.php'" class="row">
              <svg id="" class="eua"
                xmlns="http://www.w3.org/2000/svg" 
                height="20" 
            ...
            <div onclick="location.href = './espanhol/paginas/espacoAluno.php'" class="row">
              <svg id="" class="esp" 
                xmlns="http://www.w3.org/2000/svg" 
                height="20" 
  ...
  <main id="section">
    ...
    <section>
      ...
      <div onclick="location.href = './boletim.php'" class="boletim-widget">
        <div class="top">
          <svg class="paper"
            xmlns="http://www.w3.org/2000/svg" 
            width="30" 
          ...
          <h1>Confira o boletim para o seu curso da ETEC JRM</h1>        
        </div>
      </div>
    </section>
  </main>
