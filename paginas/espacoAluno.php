    ...
    <section>
      ...
      <div class="teams-widget">
        <div class="top">
          ...
          <h1>Entre no canal do <a href="https://www.microsoft.com/pt-br/microsoft-365/microsoft-teams/download-app" target="_blank" rel="noopener" class="yellow">Teams</a> da ETEC JRM</h1>        
        </div>
      </div>
