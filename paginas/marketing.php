  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>ENSINO MÉDIO COM TÉCNICO EM MARKETING</h1>
        <p>Nesta modalidade de ensino, baseada na Lei nº 13.415/17, o aluno cursará o Ensino Médio estruturado em conjunto com a formação de Técnico em Marketing
		, numa jornada de até 30 aulas semanais (até 6 aulas diárias), em cada uma das 3 séries. Ao final do curso, o aluno terá concluído o Ensino Médio e obterá,
		também, o diploma de Técnico em Marketing, com validade nacional, de acordo com o perfil profissional a seguir: O Técnico em Marketing é o profissional que
		colabora na elaboração do plano de marketing da empresa, de acordo com seu ramo ou porte, tendo a competência aliada ao domínio técnico e no planejamento e implementação de ações de vendas
		e ações de mercado. Executa tarefa de análise das vendas, preços e produtos. Operacionaliza as políticas de comunicação da empresa: fidelização de clientes, relação com fornecedores ou outras entidades.
		Operacionaliza políticas de apresentação dos produtos no ponto de venda. Executa o controle, estatísticas e operações de telemarketing. Participa na elaboração e na realização de estudos de mercado, interpreta e aplica a legislação da área.
        </p>

        <h1>MERCADO DE TRABALHO</h1>
        <p> Instituições públicas; privadas e do terceiro setor; comércio; empresas de consultoria e de forma autônoma.<br>
		<br> <a href="https://drive.google.com/file/d/1-ze2R-1epBtHxFNBbqPBekIu81QwbRHS/view">Matriz do Curso</a></p>
        </p>
