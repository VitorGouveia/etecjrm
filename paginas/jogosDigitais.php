  ...
  <main id="section">
    ...
    <section>
      ...
      <hr id="separador">
        ...
        <h1>ENSINO MÉDIO COM PROGRAMAÇÃO DE JOGOS DIGITAIS</h1>
        <p>Nesta modalidade de ensino, baseada na Lei nº 13.415/17, o aluno cursará o Ensino Médio estruturado em conjunto com a formação de Técnico em Programação de Jogos Digitais
		, numa jornada de até 30 aulas semanais (até 6 aulas diárias), em cada uma das 3 séries. Ao final do curso, o aluno terá concluído o Ensino Médio e obterá, também, o diploma de
		Técnico em Programação de Jogos Digitais, com validade nacional, de acordo com o perfil profissional a seguir: É o profissional que compõe equipes multidisciplinares na construção dos jogos digitais. Projeta, desenvolve e implementa jogos digitais.
		Codifica programas, desenvolve e editora elementos sonoros e gráficos em duas e três dimensões; gerencia e presta suporte a jogos digitais. Planeja e desenvolve ações de marketing e divulgação. Seleciona recursos de trabalho, linguagens de programação,
		ferramentas e metodologias para o desenvolvimento de jogos digitais em diversas mídias, tais como: consoles, microcomputadores, dispositivos móveis e Internet..
        </p>

        <h1>PRÉ-REQUISITOS</h1>
        <p>Possuir o certificado de conclusão do Ensino Fundamental nas modalidades: regular ou Educação de Jovens e Adultos – EJA ou Exame Nacional para Certificação de Competências de Jovens e Adultos – ENCCEJA.<br>
		<br>Coordenador do curso: Prof. Me. Robson Vanderlei Alves de Andrade<br>
